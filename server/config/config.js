...
function validateEnv() {
  ...
  if (
    ...
    (emailUser.includes("your-email") ||
      emailUser.toLowerCase().includes("example.com"))
  ) {
    logger.warn(
      "⚠️ EMAIL_USER looks like a placeholder. Replace with your real Gmail and use an App Password (see server/EMAIL_SETUP.md)",
    );
  }
}

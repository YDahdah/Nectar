...
const ownerEmail = process.env.ORDER_EMAIL || process.env.EMAIL_USER || 'youssefdahdah33@gmail.com';
const customerEmail = process.env.TEST_CUSTOMER_EMAIL || 'youssefdahdah33@gmail.com'; // Use your email for testing
